 ...
 * E7 E8 E9
 * <p>
 * E1, E4, E5, E6, and E8 are all set to E
 * For each of the remaining En, the three neighbors are checked. If they are all equal, En is set to the neighboring
 * value, otherwise, En is set to E. Eagle2x does not preserve 1-pixel details surrounded by a solid
 * color
 */
public class Eagle3x extends ImageScaler {
